import 'package:siketan_new/core/network/api_client.dart';
import 'package:siketan_new/core/services/secure_storage/secure_storage_service.dart';
...
class PublicApiClient extends ApiClient {
  PublicApiClient({TokenInterceptor? tokenInterceptor})
    : super(
        tokenInterceptor:
            tokenInterceptor ??
            TokenInterceptor(secureStorageService: SecureStorageService()),
        enableLogging: true,
      );
}

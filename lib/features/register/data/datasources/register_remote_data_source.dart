...
import 'package:siketan_new/features/register/domain/model/desa_response_model.dart';
import 'package:siketan_new/features/register/domain/model/kelompok_all_response_model.dart';
import 'package:siketan_new/features/register/domain/model/kecamatan_response_model.dart';
import 'package:siketan_new/features/register/domain/model/register_payload_model.dart';
import 'package:siketan_new/features/register/domain/model/register_response_model.dart';
  ...
  Future<DesaResponseModel> getDesaByKecamatanId(int kecamatanId) async {
    try {
      final response = await baseService.get(
        ApiEndpoints.desa,
        queryParameters: {'kecamatanId': kecamatanId},
      );
      logger.d(response.data);
      return DesaResponseModel.fromJson(response.data);
    } catch (e) {
